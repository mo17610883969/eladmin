...
public class AppServiceImpl implements AppService {
    ...
    public AppDto findById(Long id) {
        App app = ValidationUtil.getEntityById(id, () -> appRepository.findById(id).orElseGet(App::new), "App");
    ...
    public void update(App resources) {
        ...
        verification(resources);
        App app = ValidationUtil.getEntityById(resources.getId(), () -> appRepository.findById(resources.getId()).orElseGet(App::new), "App");
        app.copy(resources);
