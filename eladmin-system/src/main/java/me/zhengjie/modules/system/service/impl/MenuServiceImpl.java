...
public class MenuServiceImpl implements MenuService {
    ...
    public MenuDto findById(long id) {
        ...
        if(menu == null){
            menu = ValidationUtil.getByIdOrThrow(menuRepository, id, "Menu", Menu::new);
    ...
    public void update(Menu resources) {
        ...
        Menu menu = ValidationUtil.getByIdOrThrow(menuRepository, resources.getId(), "Menu", Menu::new);
    ...
    public Menu findOne(Long id) {
        return ValidationUtil.getByIdOrThrow(menuRepository, id, "Menu", Menu::new);
    }
