...
public class DeptServiceImpl implements DeptService {
    ...
    public DeptDto findById(Long id) {
        ...
        if(dept == null){
            dept = ValidationUtil.getEntityById(id, () -> deptRepository.findById(id).orElseGet(Dept::new), "Dept");
    ...
    public void update(Dept resources) {
        ...
        Dept dept = ValidationUtil.getEntityById(resources.getId(), () -> deptRepository.findById(resources.getId()).orElseGet(Dept::new), "Dept");
