...
public class UserServiceImpl implements UserService {
    ...
    public UserDto findById(long id) {
        ...
        if (user == null) {
            user = ValidationUtil.getByIdOrThrow(userRepository, id, "User", User::new);
    ...
    public void update(User resources) throws Exception {
        User user = ValidationUtil.getByIdOrThrow(userRepository, resources.getId(), "User", User::new);
