...
public class JobServiceImpl implements JobService {
    ...
    public JobDto findById(Long id) {
        ...
        if(job == null){
            job = ValidationUtil.getEntityById(id, () -> jobRepository.findById(id).orElseGet(Job::new), "Job");
    ...
    public void update(Job resources) {
        Job job = ValidationUtil.getEntityById(resources.getId(), () -> jobRepository.findById(resources.getId()).orElseGet(Job::new), "Job");
